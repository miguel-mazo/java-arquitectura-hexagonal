...
public class RepositorioReservaMysql implements RepositorioReserva {
    ...
    @SqlStatement(namespace = "reserva", value = "actualizarfechareserva")
    private static String sqlActualizarFechaReserva;
    ...
    public Long guardarReserva(Reserva reserva){
        ...
        paramSource.addValue("estado", reserva.getEstado().name());
    ...
    @Override
    public void actualizarFecha(Reserva reserva){
        MapSqlParameterSource paramSource = new MapSqlParameterSource();
        paramSource.addValue("id", reserva.getId());
        paramSource.addValue("fecha_reserva", reserva.getFecha_reserva().toString());
        this.customNamedParameterJdbcTemplate.getNamedParameterJdbcTemplate().update(sqlActualizarFechaReserva, paramSource);
    }
}
